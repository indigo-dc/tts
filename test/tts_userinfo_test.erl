...
update_iss_sub_test() ->
    ...
    {ok, Info} = tts_userinfo:new(),
    {ok, undefined, undefined} = tts_userinfo:return(issuer_subject, Info),
    {ok, Info1} = tts_userinfo:update_iss_sub(Issuer, undefined, Info),
    {ok, Issuer, undefined} = tts_userinfo:return(issuer_subject, Info1),
    {ok, Info2} = tts_userinfo:update_iss_sub(Issuer, Sub, Info1),
